 ...
 */
@Entity
@Table(name = "LogMessageData_Partition_14")
public class LogMessageData_Partition_14 implements Serializable, LogMessageData {

    @ManyToOne(targetEntity = LogMessage.class)
    private LogMessage logMessage;
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "PARTITION_14")
    @TableGenerator(name = "PARTITION_14",
            pkColumnName = "ENTITY", allocationSize = 5, table = "PK_ALLOCATE_SIZE_5")
    private Long id;
     
    private String label;
    private String mimeType;
    @Column(columnDefinition = DataBase.LOGMESSAGEDATA_PARTITION_14_CONTENT_COLUMN_DEFINITION)
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LogMessageData_Partition_14)) {
            return false;
        }
        LogMessageData_Partition_14 other = (LogMessageData_Partition_14) object;
