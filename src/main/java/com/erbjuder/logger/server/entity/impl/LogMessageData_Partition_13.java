 ...
 */
@Entity
@Table(name = "LogMessageData_Partition_13")
public class LogMessageData_Partition_13 implements Serializable, LogMessageData {

    @ManyToOne(targetEntity = LogMessage.class)
    private LogMessage logMessage;
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "PARTITION_13")
    @TableGenerator(name = "PARTITION_13",
            pkColumnName = "ENTITY", allocationSize = 5, table = "PK_ALLOCATE_SIZE_5")
    private Long id;
    
    private String label;
    private String mimeType;
    @Column(columnDefinition = DataBase.LOGMESSAGEDATA_PARTITION_13_CONTENT_COLUMN_DEFINITION)
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LogMessageData_Partition_13)) {
            return false;
        }
        LogMessageData_Partition_13 other = (LogMessageData_Partition_13) object;
