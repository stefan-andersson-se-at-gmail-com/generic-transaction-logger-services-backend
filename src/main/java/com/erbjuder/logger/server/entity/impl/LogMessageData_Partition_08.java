 ...
 */
@Entity
@Table(name = "LogMessageData_Partition_08")
public class LogMessageData_Partition_08 implements Serializable, LogMessageData {

    @ManyToOne(targetEntity = LogMessage.class)
    private LogMessage logMessage;
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "PARTITION_08")
    @TableGenerator(name = "PARTITION_08",
            pkColumnName = "ENTITY", allocationSize = 100, table = "PK_ALLOCATE_SIZE_100")
    private Long id;
    @Column(columnDefinition = DataBase.LOGMESSAGEDATA_PARTITION_08_CONTENT_COLUMN_DEFINITION)
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LogMessageData_Partition_08)) {
            return false;
        }
        LogMessageData_Partition_08 other = (LogMessageData_Partition_08) object;
