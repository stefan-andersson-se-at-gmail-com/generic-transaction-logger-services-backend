 ...
 */
@Entity
@Table(name = "LogMessageData_Partition_17")
public class LogMessageData_Partition_17 implements Serializable, LogMessageData {
    ...
    @Column(columnDefinition = DataBase.LOGMESSAGEDATA_PARTITION_17_CONTENT_COLUMN_DEFINITION)
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LogMessageData_Partition_17)) {
            return false;
        }
        LogMessageData_Partition_17 other = (LogMessageData_Partition_17) object;
