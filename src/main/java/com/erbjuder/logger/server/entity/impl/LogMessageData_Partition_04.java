 ...
 */
@Entity
@Table(name = "LogMessageData_Partition_04")
public class LogMessageData_Partition_04 implements Serializable, LogMessageData {

    @ManyToOne(targetEntity = LogMessage.class)
    private LogMessage logMessage;
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "PARTITION_04")
    @TableGenerator(name = "PARTITION_04",
            pkColumnName = "ENTITY", allocationSize = 1000, table = "PK_ALLOCATE_SIZE_1000")
    private Long id;
    @Column(columnDefinition = DataBase.LOGMESSAGEDATA_PARTITION_04_CONTENT_COLUMN_DEFINITION)
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LogMessageData_Partition_04)) {
            return false;
        }
        LogMessageData_Partition_04 other = (LogMessageData_Partition_04) object;
