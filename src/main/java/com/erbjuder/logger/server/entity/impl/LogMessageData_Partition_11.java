...
public class LogMessageData_Partition_11 implements Serializable, LogMessageData {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "PARTITION_11")
    @TableGenerator(name = "PARTITION_11",
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LogMessageData_Partition_11)) {
            return false;
        }
        LogMessageData_Partition_11 other = (LogMessageData_Partition_11) object;
