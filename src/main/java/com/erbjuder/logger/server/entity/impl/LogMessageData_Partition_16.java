 ...
 */
@Entity
@Table(name = "LogMessageData_Partition_16")
public class LogMessageData_Partition_16 implements Serializable, LogMessageData {

    @ManyToOne(targetEntity = LogMessage.class)
    private LogMessage logMessage;
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "PARTITION_16")
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LogMessageData_Partition_16)) {
            return false;
        }
        LogMessageData_Partition_16 other = (LogMessageData_Partition_16) object;
