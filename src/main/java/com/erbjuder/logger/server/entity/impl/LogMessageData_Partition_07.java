 ...
 */
@Entity
@Table(name = "LogMessageData_Partition_07")
public class LogMessageData_Partition_07 implements Serializable, LogMessageData {

    @ManyToOne(targetEntity = LogMessage.class)
    private LogMessage logMessage;
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "PARTITION_07")
    @TableGenerator(name = "PARTITION_07",
            pkColumnName = "ENTITY", allocationSize = 100, table = "PK_ALLOCATE_SIZE_100")
    private Long id;
    @Column(columnDefinition = DataBase.LOGMESSAGEDATA_PARTITION_07_CONTENT_COLUMN_DEFINITION)
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LogMessageData_Partition_07)) {
            return false;
        }
        LogMessageData_Partition_07 other = (LogMessageData_Partition_07) object;
