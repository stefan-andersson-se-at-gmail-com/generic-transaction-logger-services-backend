 ...
 */
@Entity
@Table(name = "LogMessageData_Partition_01")
public class LogMessageData_Partition_01 implements Serializable, LogMessageData {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LogMessageData_Partition_01)) {
            return false;
        }
        LogMessageData_Partition_01 other = (LogMessageData_Partition_01) object;
