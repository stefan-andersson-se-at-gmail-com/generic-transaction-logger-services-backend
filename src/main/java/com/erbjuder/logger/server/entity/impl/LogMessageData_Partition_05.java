 ...
 */
@Entity
@Table(name = "LogMessageData_Partition_05")
public class LogMessageData_Partition_05 implements Serializable, LogMessageData {

    @ManyToOne(targetEntity = LogMessage.class)
    private LogMessage logMessage;
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "PARTITION_05")
    @TableGenerator(name = "PARTITION_05",
            pkColumnName = "ENTITY", allocationSize = 500, table = "PK_ALLOCATE_SIZE_500")
    private Long id;
     
    private String label;
    private String mimeType;
    @Column(columnDefinition = DataBase.LOGMESSAGEDATA_PARTITION_05_CONTENT_COLUMN_DEFINITION)
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LogMessageData_Partition_05)) {
            return false;
        }
        LogMessageData_Partition_05 other = (LogMessageData_Partition_05) object;
