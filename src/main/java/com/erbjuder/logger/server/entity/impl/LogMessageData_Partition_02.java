 ...
 */
@Entity
@Table(name = "LogMessageData_Partition_02")
public class LogMessageData_Partition_02 implements Serializable, LogMessageData {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LogMessageData_Partition_02)) {
            return false;
        }
        LogMessageData_Partition_02 other = (LogMessageData_Partition_02) object;
