 ...
 */
@Entity
@Table(name = "LogMessageData_Partition_10")
public class LogMessageData_Partition_10 implements Serializable, LogMessageData {

    @ManyToOne(targetEntity = LogMessage.class)
    private LogMessage logMessage;
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "PARTITION_10")
    @TableGenerator(name = "PARTITION_10",
            pkColumnName = "ENTITY", allocationSize = 50, table = "PK_ALLOCATE_SIZE_50")
    private Long id;
    @Column(columnDefinition = DataBase.LOGMESSAGEDATA_PARTITION_10_CONTENT_COLUMN_DEFINITION)
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LogMessageData_Partition_10)) {
            return false;
        }
        LogMessageData_Partition_10 other = (LogMessageData_Partition_10) object;
