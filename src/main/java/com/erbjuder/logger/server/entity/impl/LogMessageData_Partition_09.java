 ...
 */
@Entity
@Table(name = "LogMessageData_Partition_09")
public class LogMessageData_Partition_09 implements Serializable, LogMessageData {

    @ManyToOne(targetEntity = LogMessage.class)
    private LogMessage logMessage;
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "PARTITION_09")
    @TableGenerator(name = "PARTITION_09",
            pkColumnName = "ENTITY", allocationSize = 50, table = "PK_ALLOCATE_SIZE_50")
    private Long id;
    @Column(columnDefinition = DataBase.LOGMESSAGEDATA_PARTITION_09_CONTENT_COLUMN_DEFINITION)
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LogMessageData_Partition_09)) {
            return false;
        }
        LogMessageData_Partition_09 other = (LogMessageData_Partition_09) object;
