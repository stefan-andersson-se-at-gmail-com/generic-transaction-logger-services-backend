 ...
 */
@Entity
@Table(name = "LogMessageData_Partition_15")
public class LogMessageData_Partition_15 implements Serializable, LogMessageData {

    @ManyToOne(targetEntity = LogMessage.class)
    private LogMessage logMessage;
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "PARTITION_15")
    @TableGenerator(name = "PARTITION_15",
            pkColumnName = "ENTITY", allocationSize = 5, table = "PK_ALLOCATE_SIZE_5")
    private Long id;
    @Column(columnDefinition = DataBase.LOGMESSAGEDATA_PARTITION_15_CONTENT_COLUMN_DEFINITION)
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LogMessageData_Partition_15)) {
            return false;
        }
        LogMessageData_Partition_15 other = (LogMessageData_Partition_15) object;
